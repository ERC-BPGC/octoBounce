...
STEPS = stepsPerRevolution * microsteps;
...
float calculate_height(float angle_x, float angle_y, float h) {
  ...
  float stepper_height[4] = {stepper1_height, stepper2_height, stepper3_height, stepper4_height};
